...
const copyrights = `<img class="app-login-bg" src="/assets/datavalue_theme_15/images/erpnext-hero-compressed.png">
    
<div class="text-center login-copyrights">
  Powered By 
  <a href="https://phoennix.agency/" target="_blank">Phoenix Design and Development</a>
</div>`;

$('[data-action="login-api"]').html(copyrights);
